...
export default {
   ...
   options: {
      ...
      owner: ["6282340108349"], // set owner number on here
      sessionName: "session", // for name session
      openaiKey: "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",
      prefix: /^[°•π÷×¶∆£¢€¥®™+✓_=|/~!?@#%^&.©^]/i
   },

   // Set pack name sticker on here
   Exif: {
      packId: "https://youtube.com/@",
      packName: `Sticker Ini Dibuat Oleh :`,
      packPublish: "Glospot Botz.",
      packEmail: "gz@gmail.com",
      packWebsite: "https://youtube.com/@",
